...
urlpatterns = [
    ...
    url(r'^api/v1/authenticator/delete/(?P<auth_id>[\w|\W]+)/$', views.delete_auth, name='delete-auth'),
    url(r'^api/v1/authenticator/(?P<auth_id>[\w|\W]+)/$', views.lookup_auth, name='lookup-auth'),
